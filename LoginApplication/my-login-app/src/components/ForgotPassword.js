...
const ForgotPassword = () => {
  ...
  const handleRequestReset = async () => {
    ...
    try {
      await axios.post("http://localhost:8000/request-password-reset/", { email });
      setStatus("success");
      setMessage("If your email is registered, a password reset link has been sent to your inbox.");
    } catch (error) {
